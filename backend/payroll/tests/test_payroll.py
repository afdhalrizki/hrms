...
class PayrollExtendedTestCase(TenantTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user = Employee.objects.create(
            ...
            department=cls.dept, role=cls.role, grade=cls.gol,
    ...
    def test_overtime_precedence_logic(self):
        """Verify precedence: Grade Rate > Tenant Rate > Divisor."""
        ...
        # 3. Grade Rate (200,000 * 10 = 2,000,000)
    ...
    def test_payslip_self_service_filter(self):
        ...
        emp2 = Employee.objects.create(
            ...
            department=self.dept, role=self.role, grade=self.gol, join_date="2024-01-01"
        )
