...
The frontend uses a dual-layer strategy with **100% pass rate** across **266 mission-critical tests**.

### Unit Testing (Vitest) - 205 Tests
```bash
node scripts/run_unit_tests.mjs
```

### End-to-End Testing (Playwright) - 61 Tests
