...
The frontend uses a dual-layer strategy with **100% pass rate** across **288 mission-critical tests**.

### Unit Testing (Vitest) - 218 Tests
```bash
node scripts/run_unit_tests.mjs
```

### End-to-End Testing (Playwright) - 70 Tests
