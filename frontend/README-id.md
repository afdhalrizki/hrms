...
Frontend menggunakan strategi lapisan ganda dengan **tingkat kelulusan 100%** di **252 tes krusial**.

### Unit Testing (Vitest) - 194 Tes
```bash
node scripts/run_unit_tests.mjs
```

### End-to-End Testing (Playwright) - 58 Tes
