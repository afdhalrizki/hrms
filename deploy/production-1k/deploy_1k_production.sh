...
# --- Safe Deployment Script for HRMS (Production 1K Environment) ---
# This script is designed to safely deploy to the Production 1K server.
...
echo "🚀 Starting Safe Deployment Process for HRMS Production 1K..."
...
if ! "$SCRIPT_DIR/backup_1k.sh"; then
