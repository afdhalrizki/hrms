...
1.  **Modul Kehadiran ([attendance.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/attendance.id.md)):** 
...
2.  **Modul Penagihan & Kuota ([billing.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/billing.id.md)):** 
    Manajemen langganan tenant, pemrosesan invoice terintegrasi Midtrans, dan pemantauan kuota data aktif.
3.  **Modul Data Utama ([core.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/core.id.md)):** 
...
4.  **Modul Notifikasi ([notifications.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/notifications.id.md)):** 
...
5.  **Modul Penggajian ([payroll.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/payroll.id.md)):** 
...
6.  **Modul Kinerja ([performance.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/performance.id.md)):** 
...
7.  **Modul Reimbursement ([reimbursement.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/reimbursement.id.md)):** 
    Sistem pengajuan klaim pengeluaran (reimburse kacamata, kesehatan, transportasi) dengan sistem approval berjenjang.
8.  **Modul Layanan Bantuan ([support.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/support.id.md)):** 
    Sistem helpdesk tiket internal bagi HR Admin klien untuk meminta bantuan teknis langsung ke Superadmin/Support HariKerja.
9.  **Modul Perusahaan & Domain ([tenants.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/tenants.id.md)):** 
    Pengelolaan siklus hidup sub-domain per-perusahaan, isolasi database, dan otorisasi pendaftaran penyewa baru.
10. **Modul Pengguna ([users.id.md](file:///home/afdhal/data/hr/hrms/docs/modules/users.id.md)):** 
